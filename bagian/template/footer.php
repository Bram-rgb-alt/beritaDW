                ...
                <ul class="space-y-3">
                    <li class="flex items-center justify-center md:justify-end space-x-2">
                        ...
                        <a href="mailto:kontak@portalMerahKebanggan.id"
                            class="hover:text-red-300 transition">bramwelltambunan@gmail.com</a>
                    </li>
                    <li class="flex items-center justify-center md:justify-end space-x-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                        ...
                        <a href="tel:+628123456789" class="hover:text-red-300 transition">+62 813 6116 3339</a>
                    </li>
                    <li class="flex items-center justify-center md:justify-end space-x-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                        ...
                        <a href="https://www.instagram.com/rassidrsdslpa05_?igsh=dWJld2pwY21ndjdv&utm_source=qr"
                            target="_blank" class="hover:text-red-300 transition">@portalMerahKebanggan</a>
                    </li>
                </ul>
            </div>
        </div>
